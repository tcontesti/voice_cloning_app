...
\textbf{Proponentes:} & Marc Link Cladera (graduado, EPS-UIB) · Andrés Borrás Santos (graduado, EPS-UIB) \\
...
\item \textbf{UIB} (Escola Politècnica Superior) --- Marc Link Cladera, Andrés Borrás Santos y Antonio Contestí Coll, graduados en Ingeniería Informática, asumen el diseño técnico, la implementación, la auditoría algorítmica, el \emph{benchmark} de 528 generaciones y la integración \emph{end-to-end}.
