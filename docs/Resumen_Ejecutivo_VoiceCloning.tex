...
& Antonio Contestí Coll (estudiante Ing. Informática, EPS-UIB, TFG jun.~2026) \\
...
\item \textbf{UIB} (Escola Politècnica Superior) --- Andrés Borrás Santos (graduado en Ingeniería Informática), Marc Link Cladera y Antonio Contestí Coll (estudiantes de Ingeniería Informática, TFG previsto para junio 2026) asumen el diseño técnico, la implementación, la auditoría algorítmica, el \emph{benchmark} de 528 generaciones y la integración \emph{end-to-end}.
